...
#define Element_CheckExact(op) (Py_TYPE(op) == m_state->Element_Type)
...
/*[clinic end generated code: output=65e39a1208f3b59e input=39b1b9dde072e05a]*/
{
    ...
    if (checkpath(tag) || namespaces != Py_None) {
        ...
        return _PyObject_CallMethodIdObjArgs(
            m_state->elementpath_obj, &PyId_findall, self, tag, namespaces, NULL
            );
    }
...
_elementtree_Element_getiterator_impl(ElementObject *self, PyTypeObject *cls,
                                      PyObject *tag)
/*[clinic end generated code: output=be24c360fed43ff8 input=b4292d3540057cdb]*/
{
    ...
    return _elementtree_Element_iter_impl(self, cls, tag);
}
...
#define TreeBuilder_CheckExact(op) (Py_TYPE(op) == self->m_state->treebuilder_type)
...
static int
treebuilder_set_element_text_or_tail(elementtreestate *m_state, PyObject *element,
                ...
                Py_ssize_t column, const char *message)
{
    ...
    error = PyObject_CallFunctionObjArgs(parseerror_obj, errmsg, NULL);
    Py_DECREF(errmsg);
    if (!error)
        return;
...
/*[clinic end generated code: output=64068c7a85146f67 input=8b04feacbbd62a99]*/
{
    PyObject *m;
    elementtreestate *m_state;
