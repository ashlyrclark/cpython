...
static PyType_offsets bytesio_offsets = {
    .dict = offsetof(bytesio, dict),
    .weaklist = offsetof(bytesio, weakreflist)
};

static PyType_Slot PyBytesIO_Type_slots[] = {
